...
public  class SortableObjectComparator {
	...
	public static Comparator<SortableObject> IdValueAscComparator 
	= new Comparator<SortableObject>() {
	...
	public static Comparator<SortableObject> IdValueDescComparator 
	= new Comparator<SortableObject>() {
		public int compare(SortableObject obj1, SortableObject obj2){
			SortableObject entry1 = obj1;
			SortableObject entry2 = obj2;
	...
	public static Comparator<SortableObject> IdAscComparator 
	= new Comparator<SortableObject>() {
		public int compare(SortableObject obj1, SortableObject obj2){
			SortableObject entry1 = obj1;
			SortableObject entry2 = obj2;
	...
	public static Comparator<SortableObject> ValueAscComparator 
	= new Comparator<SortableObject>() {
		public int compare(SortableObject obj1, SortableObject obj2){
			SortableObject entry1 = obj1;
			SortableObject entry2 = obj2;
